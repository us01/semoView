		...
		<br><label id="checkVerify"></label>
         ...
         <div class="w3-container">
            ...
            <div style="text-align: center;">
               ...
               id="userPwd" name="userPwd" placeholder="비밀번호" style="width:270px; display: inline-block; margin-left: -22px;">
            </div>
         </div>

         <div class="w3-container" style="display:inline-block;">
            <p><span class="tag" style="background-color: white; color:black; margin-left: -95px; display: inline-block;">비밀번호확인</span></p>
            <div style="text-align: center;">
               <input type="password" class="w3-input w3-change" name="userPwdCheck" id="userPwdCheck" placeholder="비밀번호 확인" style="margin-top: 2px; margin-left: 32px; display: inline-block; width:270px;">
			...
			<div class="w3-container">
				<p>
					<span class="tag" style="background-color: white; color:black; display: inline-block; margin-left: -10px;">핸드폰번호</span>
				</p>
				<div style="text-align: center;">
					<input type="text" class="w3-input w3-change" id="phone" name="phone"
						placeholder="핸드폰번호를 입력해주세요" style="width:270px; display: inline-block; margin-left: -40px;" maxlength="11">
				</div>
			</div>
			
         <div class="w3-container">
            <p>
               <span class="tag" style="background-color: white; color:black; display: inline-block; margin-left: -9px;">나이</span>
            </p>
            <div style="text-align: center;">
         ...
         <div class="w3-container">
            <p>
               <span class="tag" style="background-color: white; color:black; display: inline-block; margin-left: -8px;">성별</span>
            </p>
