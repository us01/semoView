...
<body>
	...
	<div class="body1">
		<div class="writerBox">
			<form class="payForm" id="payMent" action="<%=request.getContextPath()%>/payMent.vo"
				method="post">
				...
				<table>
					...
					<tr>
					<tr>
						<td>&nbsp;<input type="hidden" name="serviceNo"
							value=<%=serviceNo %>></td>
						<td><textarea class="payTextarea" name="textarea" cols="93" rows="30">
						전자금융거래 기본약관
...
이 약관은 2012년 7월 31일부터 적용합니다.
					...
					<tr>
						...
						<p class="pay">결제 동의</p></td>
					</tr>
					<tr align="center">
						<td>&nbsp;</td>
						<td colspan="2"><input type=submit value="결제하기" id="btn">
							<input type=button value="돌아가기" onclick="backNotice()">
						<td>&nbsp;</td>
					</tr>
				</table>
			</form>
